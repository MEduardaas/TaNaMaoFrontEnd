...
export default function Footer() {
  return (
    <footer className="absolute bottom-0 bg-primary text-white w-full max-h-max flex items-start gap-20 p-8 pb-15 lg:px-18">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 w-full">
        ...
        <div className="flex flex-col gap-2">
          ...
          <LinkNavigation href="/" className="flex items-center gap-2 text-sm">
            <Instagram />
            Instagram
          </LinkNavigation>
        </div>
      ...
      <p className="absolute bottom-4 inset-x-0 text-center text-sm">
